...
export default function Links() {
  return (
    <div className="m-auto max-w-xl">
      <div className="rounded-3xl bg-white border border-gray-100 shadow-2xl shadow-gray-600/10">
        <div className="p-8 py-8 sm:p-10">
          <div className="space-y-4">
            <h2 className="mb-8 text-2xl text-gray-800">
              <span>
                Ahoy 👋, welcome aboard stranger. Nice to meet you 🥰.
              </span>
            </h2>
          </div>
          <div className="mt-4 grid space-y-4">
            <Link href="/portfolio">
              <a className="group relative flex h-11 items-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-white before:border hover:before:border-primary before:border-gray-200 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 disabled:before:scale-100">
                <span className="w-full relative flex justify-center items-center gap-3 text-base font-medium text-gray-600">
                  <div className="w-8 h-8 absolute left-0">
                    <Image
            ...
            <Link href="https://www.linkedin.com/in/christopher-odhiambo-2870331aa">
              <a className="group relative flex h-11 items-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-white before:border hover:before:border-primary before:border-gray-200 before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 disabled:before:scale-100">
                <span className="w-full relative flex justify-center items-center gap-3 text-base font-medium text-gray-600">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
